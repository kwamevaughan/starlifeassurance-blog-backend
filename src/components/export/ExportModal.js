...
// import { getTenantHeaders } from "../../utils/tenantHeaders"; // Not using tenant
    ...
    try {
      ...
      const response = await fetch("/api/export/email", {
        ...
        headers: {
          ...
          // ...getTenantHeaders(tenant), // Not using tenant
        },
        body: JSON.stringify({
          data: exportData,
          headers: headers,
